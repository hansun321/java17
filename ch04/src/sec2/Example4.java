...
public class Example4 {
    public static void main(String[] args) {
        ...
        int idx = nick.indexOf('g');    //해당 문자의 인텍스를 반환
        System.out.println("g의 문자 인덱스 값 : " + idx);
        idx = nick.indexOf('i');    //해당 문자의 인텍스를 반환
        ...
        char[] nArr = nick.toCharArray(); //문자열을 => 문자 배열 k i m k i t a e
        byte[] bArr = nick.getBytes();
        System.out.println("@ 2번째 : " + nArr[2]); //m
        System.out.println("# 2번째 : " + bArr[2]); //109 -> m의 아스키 코드값
        ...
        String[] stArr2 = chunjae2.split("/|-"); /* regex "[/-]"와 같음 */
