...
public class Example2 {
    public static void main(String[] args) {
        ...
        } else if (py >= 80) { // 90미만인게 내포되어 있음
            System.out.println("우");
        } else if (py >= 70) { // 80미만인게 내포되어 있음
            System.out.println("미");
        } else if (py >= 60) { // 70미만인게 내포되어 있음
        ...
        같지 않는 경우 반드시 default 를 설정하여야 하며, case의 종료는 break로
        해야 하며, break가 지정되지 않으면, 아래 case의 연산까지 모두 진행하게됨
        */
